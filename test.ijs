...
test_occ_self =: 3 : 'assert. (< 2) occ (<2)'
...
test_ext_equal_nonvar =: 3 : 'assert. ''_.;_.;,2''&-: ((5!:5) < ''a'') [ a =. (_. ; _. ; _.) ext ((,2);,2)'
test_ext_equal_var =: 3 : 'assert. _1&-: (_. ; _. ; _.) ext (2;2)'
test_ext_occ =: 3 : 'assert. _1&-: (_. ; _. ; _.) ext (2 ; < < 2)'
test_ext_same =: 3 : 'assert. ''(<_.),(<_.),<<2''&-: ((5!:5) < ''a'') [ a =. (_. ; _. ; _.) ext ((<2); < < 2)'
test_ext_avoid_duplicate =: 3 : 'assert. ''_.;_.;''''z'''';2''&-: ((5!:5) < ''a'') [ a =.  (_. ; _. ; ''z'' ; _.) ext (3 ; ''z'')'
test_ext_no_path_compression =: 3 : 'assert. ''_.;_.;''''z'''';2;3''&-: ((5!:5) < ''a'') [ a =.  (_. ; _. ; ''z'' ; 2 ; _.) ext (4 ; 2)'
...
test_infinite_stream_interleave =: 3 : 'assert. ((<<,6),(<<,5),(<<,6),(<<,5),(<<,6),<<,5)&-: 6 cis fives_and_sixes'
