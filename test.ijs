...
NB.test_occurs_scalar=:3 :'assert.(0) occurs (0) (0;'''';'''')'
NB.test_occurs_null=:3 :'assert.(<'''') occurs (<'''') (0;'''';'''')'
NB.test_occurs_var=:3 :'assert.(<0) occurs (<0) (0;'''';'''')'
NB.test_occurs_multivar=:3 :'assert.(0;1;4) occurs (0;1;4) (0;'''';'''')'
NB.test_occurs_yes =: 3 :'assert.0&=(<0) occurs (<<0)  (0;'''';'''')'
NB.test_occurs_no =: 3 :'assert.(<0) occurs (<1)  (0;'''';'''')'
NB.test_occurs_all=:3 :'assert.0&=(0;1;4) occurs ((<0);(<1);<<4) (0;'''';'''')'
NB.test_occurs_some=:3 :'assert.0&=(0;1;4) occurs (''a'';1;<<(4;<<0)) (0;'''';'''')'
NB.test_occurs_none=:3 :'assert.(''a'';0;1) occurs (''a'';1;<<(4;<<0)) (0;'''';'''')'
NB.test_occurs_findyes =: 3 :'assert.0&=(<0) occurs (<1)  (0;(<1);<<0)'
NB.test_occurs_findyes2 =: 3 :'assert.0&=(<0) occurs (<<1)  (0;(<1);<<0)'
NB.test_occurs_findno =: 3 :'assert.(<0) occurs (<<1) (0;(<1);<<2)'
