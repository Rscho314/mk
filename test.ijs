...
test_uni_unequal_shape=:3 :'assert. 0&= (<4) uni (3;2) (<5)'
test_uni_equal=:3 : 'assert.(<2)&-:2 uni 2 (<2)'
test_uni_occ=:3 : 'assert.0&= 2 uni (<2) (<3)'
...
test_uni_subtree =: 3 : 'assert. (3 2;<(''a'';''b''))&-: 2 uni (''a'';''b'') (<3)'
test_uni_subtree_var =: 3 : 'assert. (4 2;<(3;''b''))&-: 2 uni (3;''b'') (<4)'

uni_scope_expect =: 'domain error'
test_uni_scope =: 3 : '2 uni 3 (<3)'
