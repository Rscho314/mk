...
test_find_natself =: 3 : 'assert. 2&-:(2 2;2) find 2'
test_find_nullempty =: 3 : 'assert. ''''&-:(<2) find '''''
test_find_nullnat =: 3 : 'assert. ''''&-:(2 2;2) find '''''
...
test_unify_null_nat =: 3 : 'assert.(4 3;'''')&-: '''' unify 3 (<4)'
test_unify_nat_nat =: 3 : 'assert.(5 4;3)&-:4 unify 3 (<5)'
test_unify_bnat_bnat =: 3 : 'assert.(5 4;3)&-:(<4) unify (<3) (<5)'
test_unify_unequal_shape=:3 :'assert.0&=(<4) unify (3;2) (<2)'
test_unify_equal=:3 : 'assert.(<2)&-:2 unify 2 (<2)'
test_unify_occurs=:3 : 'assert.0&= 2 unify (<2) (<2)'
test_unify_occurs_walk=:3 : 'assert.0&=2 unify (<3) (4 3;2)'
test_unify_crisscross =: 3 : 'assert. (4 2 3;''b'';''a'')&-:(''a'';2) unify (3;''b'') (<4)'
test_unify_nested =: 3 : 'assert.(4 2 3;''d'';''c'')&-:(''a'';<<(''c'';2)) unify (''b'';<<(3;''d'')) (<4)'
test_unify_walk =: 3 : 'assert.(4 2 3;3;1)&-:2 unify 3 (4 2 3;3;1)'
test_unify_walk_add =: 3 : 'assert.(5 2 3 2;4;''a'';3)&-:2 unify 3 (5 2 3;4;''a'')'